...
const AdvisorHeader = ({ toggleSidebar, onLogout, sidebarOpen }: HeaderProps) => {
  ...
  const notifications = [
    { id: 1, text: "Se te ha asignado un nuevo trámite", time: "Hace 5 minutos", unread: true },
    { id: 2, text: "Un estudiante respondió a tu comentario", time: "Hace 1 hora", unread: true },
    { id: 3, text: "Recordatorio: Tienes 2 trámites pendientes", time: "Ayer", unread: false },
  ];
        ...
        <div className="flex items-center">
          ...
          <div className={`relative ml-4 ${sidebarOpen ? 'md:ml-0' : 'md:ml-4'}`}>
            ...
            <input
              ...
              placeholder="Buscar trámites asignados..."
              value={searchTerm}
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="ml-2 text-sm font-medium hidden md:block">{userName || 'Asesor Académico'}</span>
            </button>

            {userMenuOpen && (
              <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg py-2 z-50 border border-gray-200">
                <div className="px-4 py-3 border-b border-gray-200">
                  <p className="text-sm font-medium text-gray-900">{userName || 'Asesor Académico'}</p>
                  <p className="text-xs text-gray-500 mt-1">advisor@ccd.edu.pe</p>
                </div>
                <div className="py-1">
                  <button
                    onClick={() => {
